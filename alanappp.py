...
gra=st.selectbox(label='select delay vs feature graphs ',options=['airline vs delay','day vs delay'],index=None)
...
rau=st.selectbox(label='select any model..',options=['knneighbors','multinomialNB','guassianNB','random forest','xgbclassifier','xgbrfclassifier'],index=None)
if rau=='knneighbors':
